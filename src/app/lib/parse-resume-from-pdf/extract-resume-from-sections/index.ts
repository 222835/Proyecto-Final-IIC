...
import { extractCertifications } from "lib/parse-resume-from-pdf/extract-resume-from-sections/extract-certification";
...
export const extractResumeFromSections = (
  ...
  const { certifications } = extractCertifications(sections); //MOD added w/ variable name change
