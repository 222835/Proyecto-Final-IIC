...
export const ResumeTable = ({ resume }: { resume: Resume }) => {
  ...
  const certifications = [...resume.certifications.descriptions]  //MOD NEW
  return (
    <table className="mt-2 w-full border text-sm text-gray-900">
      <tbody className="divide-y text-left align-top">
        ...
        <TableRowHeader>Certifications</TableRowHeader>         {/*MOD added*/}
        <TableRow label="Descriptions" value={certifications} />{/*MOD added*/}
      </tbody>
    </table>
  );
};
